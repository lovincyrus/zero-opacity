...
open class Directions: NSObject {
     ...
     */
    open func calculateDirections(options: RouteOptions, completionHandler: @escaping CompletionHandler) -> URLSessionDataTask {
     ...
     */
    open func URLForCalculatingDirections(options: RouteOptions) -> URL {
