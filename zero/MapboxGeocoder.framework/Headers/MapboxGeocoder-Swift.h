...
@property (nonatomic) enum PlacemarkScope allowedScopes;
...
///
/// \param query A place name or address to search for.
...
///
/// \param queries An array of up to 50 place names or addresses to search for.
...
@property (nonatomic, readonly) enum PlacemarkScope scope;
